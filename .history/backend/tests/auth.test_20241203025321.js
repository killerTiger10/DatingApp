...
describe("Auth Routes", () => {
  ...
  it("should register a new user with additional fields", async () => {
    console.log("Test: Register a new user with additional fields");
    ...
    const requestData = {
      ...
      age: 25,
      gender: "male",
      interests: ["hiking", "reading"], // Example interests
    };
    ...
    // Check if the response includes all provided fields
    ...
    expect(response.body).toHaveProperty(
      "gender",
      requestData.gender.toLowerCase()
    );
    expect(response.body.interests).toEqual(
      expect.arrayContaining(requestData.interests)
    );
